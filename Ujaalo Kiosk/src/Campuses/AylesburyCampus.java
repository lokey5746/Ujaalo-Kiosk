...
import InternalFrames.AylesLocation;
import InternalFrames.AylesAbout;

import InternalFrames.AylesGallery;
 ...
 * @author User
 */
public class AylesburyCampus extends javax.swing.JFrame {

    /**
     * Creates new form AylesburyCampus
     */
    public AylesburyCampus() {
        initComponents();
    }
    ...
    private void btn_locationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_locationActionPerformed
        ...
        AylesLocation al = new AylesLocation();
        LutonPane.add(al);
        al.show();
    ...
    private void btn_galleryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_galleryActionPerformed
        ...
        AylesGallery ag = new AylesGallery();
        LutonPane.add(ag);
        ag.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AylesburyCampus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AylesburyCampus().setVisible(true);
            }
        });
    }
