...
import InternalFrames.LutonLocation;
import InternalFrames.LutonGallery;
import InternalFrames.LutonAbout;
...
public class LutonCampus extends javax.swing.JFrame {
    ...
    private void btn_locationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_locationActionPerformed
        ...
        LutonLocation ll = new LutonLocation();
        LutonPane.add(ll);
        ll.show();
    ...
    private void btn_galleryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_galleryActionPerformed
        ...
        LutonGallery lg = new LutonGallery();
        LutonPane.add(lg);
        lg.show();
