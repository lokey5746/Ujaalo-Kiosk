 ...
 * @author User
 */
public class BedfordLocation extends javax.swing.JInternalFrame {

    /**
     * Creates new form BedfordLocation
     */
    public BedfordLocation() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Bedford Location");

        jPanel1.setBackground(new java.awt.Color(99, 110, 114));
        jPanel1.setForeground(new java.awt.Color(99, 110, 114));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/bedford-campus-map.png"))); // NOI18N
        ...
        jLabel5.setText("Bedfordshire Campus Location");
