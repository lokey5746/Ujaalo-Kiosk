...
import InternalFrames.Accomodation;
import InternalFrames.StudentLife;
import InternalFrames.lutonAccomodation;
import Ujaalo.StudentDashboard;
/**
 *
 * @author User
 */
public class StudentFacilities extends javax.swing.JFrame {

    /**
     * Creates new form StudentFacilities
     */
    ...
    private void initComponents() {
        ...
        BedfordPane = new javax.swing.JDesktopPane();
        ...
        btn_about.setText("Campuses Services");
        ...
        btn_location.setText("     Bedford Accomodation");
        ...
        btn_gallery.setText("Luton Accomodation");
        ...
        btn_services.setText("       Student Life          ");
        ...
        BedfordPane.setLayer(jLabel4, javax.swing.JLayeredPane.DEFAULT_LAYER);

        javax.swing.GroupLayout BedfordPaneLayout = new javax.swing.GroupLayout(BedfordPane);
        BedfordPane.setLayout(BedfordPaneLayout);
        BedfordPaneLayout.setHorizontalGroup(
            BedfordPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        BedfordPaneLayout.setVerticalGroup(
            BedfordPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, BedfordPaneLayout.createSequentialGroup()
    ...
    private void btn_locationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_locationActionPerformed
        ...
        Accomodation bl = new Accomodation();
        BedfordPane.add(bl);
        bl.show();
    ...
    private void btn_galleryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_galleryActionPerformed
        // TODO add your handling code here:
        lutonAccomodation bg = new lutonAccomodation();
        BedfordPane.add(bg);
        bg.show();
    ...
    private void btn_servicesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_servicesActionPerformed
        ...
        StudentLife bg = new StudentLife();
        BedfordPane.add(bg);
        bg.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentFacilities.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentFacilities().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JDesktopPane BedfordPane;
